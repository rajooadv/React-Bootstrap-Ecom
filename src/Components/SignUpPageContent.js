...
import '../style/SignUpContent.css'
        ...
        <>
            <div className='d-flex '>
                ...
                <div className="signInData container">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label font-causten enterEmailLable">Email Address</label>
                    ...
                    <p className='signUpDesc'>Use 8 or more characters with a mix of letters, numbers & symbols</p>
                    <div class="form-check my-2">
                        <input type="checkbox" class="form-check-input" id="customCheckbox"/>
                            <label class="form-check-label agreeLabel" for="customCheckbox">Agree to our <a href="#">Terms of use</a> and <a href="#">Privacy Policy </a></label>
                    </div>

                    <div class="form-check my-3">
                        <input type="checkbox" class="form-check-input" id="customCheckbox"/>
                            <label class="form-check-label agreeLabel" for="customCheckbox">Subscribe to our monthly newsletter</label>
                    </div>


                    <div className="bottomButtonSignInPage">
                        <button className='signInPageButton border border-0 fw-bold loginButton'>Sign In</button>
                        <p className='alreadyHaveAccount  my-3'>Already have an  account?  <span className='dontHaveAccountSignup'>Log in</span></p>
                    </div>
                </div>
